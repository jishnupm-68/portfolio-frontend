...
const navigation = [
  ...
  { name: 'Skill', to: '/skill', current: false },
]
        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex shrink-0 items-center">
              {user && <h1 className='font-bold text-3xl text-gray-200'>{user.name}</h1>}
            </div>
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <button
              type="button"
              className="relative rounded-full p-1 text-gray-400 focus:outline-2 focus:outline-offset-2 focus:outline-indigo-500 hover:bg-white/5 dark:hover:text-white"
            >
              <ThemeToggler />
            </button>
