                    ...
                    <div>
                        ...
                        <button className=' ml-2 btn btn-info'>
                            <Link to={"/admin/project/editProject"}
                                state={{
                                    _idState: _id, titleState: title, descriptionState: description, imageUrlState: imageUrl, liveProjectUrlState: liveProjectUrl, frontEndUrlState: frontEndUrl, backEndUrlState: backEndUrl, technologiesState: technologies, categoryState: category,
                                }}
                            >Edit</Link></button>
                    </div>
                </div>
