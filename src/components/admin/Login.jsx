...
const Login = () => {
    ...
    const login= async(email, password)=>{
        try {
            const userResult = await axios.post(BASE_URL+"/login",{email,password},{withCredentials:true})
            console.log("user",userResult?.data?.data)
    ...
    const signup=async()=>{
        try {
            ...
            const user = await axios.post(BASE_URL+"/signup",{name,email,password},{withCredentials:true})
            console.log(user)
